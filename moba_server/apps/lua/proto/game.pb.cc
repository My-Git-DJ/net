...
class ExiteResDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<ExiteRes>
      _instance;
} _ExiteRes_default_instance_;
...
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  {
    void* ptr = &::_ExiteRes_default_instance_;
    new (ptr) ::ExiteRes();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::ExiteRes::InitAsDefaultInstance();
}

void InitDefaultsExiteRes() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsExiteResImpl);
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  0,
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::ExiteRes, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::ExiteRes, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::ExiteRes, status_),
  0,
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&::_ExiteRes_default_instance_),
...
void ExiteRes::InitAsDefaultInstance() {
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int ExiteRes::kStatusFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

ExiteRes::ExiteRes()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_game_2eproto::InitDefaultsExiteRes();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:ExiteRes)
}
ExiteRes::ExiteRes(const ExiteRes& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(NULL),
      _has_bits_(from._has_bits_),
      _cached_size_(0) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  status_ = from.status_;
  // @@protoc_insertion_point(copy_constructor:ExiteRes)
}

void ExiteRes::SharedCtor() {
  _cached_size_ = 0;
  status_ = 0;
}

ExiteRes::~ExiteRes() {
  // @@protoc_insertion_point(destructor:ExiteRes)
  SharedDtor();
}

void ExiteRes::SharedDtor() {
}

void ExiteRes::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* ExiteRes::descriptor() {
  ::protobuf_game_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_game_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ExiteRes& ExiteRes::default_instance() {
  ::protobuf_game_2eproto::InitDefaultsExiteRes();
  return *internal_default_instance();
}

ExiteRes* ExiteRes::New(::google::protobuf::Arena* arena) const {
  ExiteRes* n = new ExiteRes;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void ExiteRes::Clear() {
// @@protoc_insertion_point(message_clear_start:ExiteRes)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
bool ExiteRes::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:ExiteRes)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:ExiteRes)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:ExiteRes)
  return false;
#undef DO_
}

void ExiteRes::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:ExiteRes)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:ExiteRes)
}

::google::protobuf::uint8* ExiteRes::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:ExiteRes)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:ExiteRes)
  return target;
}

size_t ExiteRes::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:ExiteRes)
  size_t total_size = 0;
...
void ExiteRes::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:ExiteRes)
  GOOGLE_DCHECK_NE(&from, this);
  const ExiteRes* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const ExiteRes>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:ExiteRes)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:ExiteRes)
    MergeFrom(*source);
  }
}

void ExiteRes::MergeFrom(const ExiteRes& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:ExiteRes)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void ExiteRes::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:ExiteRes)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void ExiteRes::CopyFrom(const ExiteRes& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:ExiteRes)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ExiteRes::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000001) != 0x00000001) return false;
  return true;
}

void ExiteRes::Swap(ExiteRes* other) {
  if (other == this) return;
  InternalSwap(other);
}
void ExiteRes::InternalSwap(ExiteRes* other) {
  using std::swap;
  swap(status_, other->status_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::google::protobuf::Metadata ExiteRes::GetMetadata() const {
  protobuf_game_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_game_2eproto::file_level_metadata[kIndexInFileMessages];
}
