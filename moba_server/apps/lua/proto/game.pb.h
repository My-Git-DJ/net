...
extern ExiteResDefaultTypeInternal _ExiteRes_default_instance_;
class LoginRes;
...
class ExiteRes : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ExiteRes) */ {
 public:
  ExiteRes();
  virtual ~ExiteRes();

  ExiteRes(const ExiteRes& from);

  inline ExiteRes& operator=(const ExiteRes& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  ExiteRes(ExiteRes&& from) noexcept
    : ExiteRes() {
    *this = ::std::move(from);
  }

  inline ExiteRes& operator=(ExiteRes&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ExiteRes& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ExiteRes* internal_default_instance() {
    return reinterpret_cast<const ExiteRes*>(
               &_ExiteRes_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    1;

  void Swap(ExiteRes* other);
  friend void swap(ExiteRes& a, ExiteRes& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ExiteRes* New() const PROTOBUF_FINAL { return New(NULL); }

  ExiteRes* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const ExiteRes& from);
  void MergeFrom(const ExiteRes& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(ExiteRes* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:ExiteRes)
 private:
  void set_has_status();
  void clear_has_status();
  ...
  ::google::protobuf::int32 status_;
  friend struct ::protobuf_game_2eproto::TableStruct;
  friend void ::protobuf_game_2eproto::InitDefaultsExiteResImpl();
};
// -------------------------------------------------------------------
...
// required int32 status = 1;
inline bool ExiteRes::has_status() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ExiteRes::set_has_status() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ExiteRes::clear_has_status() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ExiteRes::clear_status() {
  status_ = 0;
  clear_has_status();
}
inline ::google::protobuf::int32 ExiteRes::status() const {
  // @@protoc_insertion_point(field_get:ExiteRes.status)
  return status_;
}
inline void ExiteRes::set_status(::google::protobuf::int32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:ExiteRes.status)
}
