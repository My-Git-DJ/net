...
#define SERVICE_FUNCTION_MAPPING "service_finction_mapping"
...
//protobuf:message k,v ->lua table
...
register_service_export(lua_State* tolua_S) {
	...
	if (lua_istable(tolua_S, -1)) {
		tolua_open(tolua_S);
		tolua_module(tolua_S, "service_wrapper", 0);
		tolua_beginmodule(tolua_S, "service_wrapper");
